...
int main()
{
    ...
    while(t--)
    {
        ...
        else
        {
            ...
            if(a[1][2]!=0)
            {
                cnt1++;v1.push_back({1,2});
            }
            if(a[2][1]!=0)
            {
                 cnt1++;v1.push_back({2,1});
            }
            if(a[n-1][n]!=1)
            {
               cnt1++;v1.push_back({n-1,n});
            }
            if(a[n][n-1]!=1)
            {
                 cnt1++;v1.push_back({n,n-1});
            }
            ...
            if(a[1][2]!=1)
            {
                cnt2++;v2.push_back({1,2});
            }
            if(a[2][1]!=1)
            {
                 cnt2++;v2.push_back({2,1});
            }
            if(a[n-1][n]!=0)
            {
               cnt2++;v2.push_back({n-1,n});
            }
            if(a[n][n-1]!=0)
            {
                 cnt2++;v2.push_back({n,n-1});
            }
            ...
            {
                cout<<cnt1<<endl;
                for(auto x:v1) cout<<x.ff<<" "<<x.ss<<endl;
            }
            else
            {
                cout<<cnt2<<endl;
                for(auto x:v2) cout<<x.ff<<" "<<x.ss<<endl;
            }
        }
