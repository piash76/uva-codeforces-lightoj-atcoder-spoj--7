...
int main()
{
   ...
   cin>>t;
    while(t--)
    {
        ...
        if(a==1 and c==1)
        {
             if(b>=1 and b<=n/2 and d>=1 and d<=n/2) cy;
             else if(b>=n/2+1 and b<=n and d>=n/2+1 and d<=n) cy;
             else cn;
        }
        else if(a==2 and c==2)
        {
            if(b>=1 and b<=m/2 and d>=1 and d<=m/2) cy;
            else if(b>=m/2+1 and b<=m and d>=m/2+1 and d<=m) cy;
            else cn;
        }
        else if(a==1 and c==2)
        {
            if(b>=1 and b<=n/2 and d>=1 and d<=m/2) cy;
            else if(b>=n/2+1 and b<=n and d>=m/2+1 and d<=m) cy;
            else cn;
        }
        else if(a==2 and c==1)
        {
            if(b>=1 and b<=m/2 and d>=1 and d<=n/2) cy;
            else if(b>=m/2+1 and b<=m and d>=n/2+1 and d<=n) cy;
            else cn;
        }
