...
//ll a[maxn];
///https://www.youtube.com/watch?v=i7xZ4Yd_jN8&t=85s
///this is only usable if all updates are occured before accesing index
...
int main()
{
  ...
  //  cout<<endl;
    ...
    while(q--)
    {
        ll l,r,val;  ///l to r update with val
        cin>>l>>r>>val;
        up[l]+=val;
        up[r+1]+=(-val);
    }
