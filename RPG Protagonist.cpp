        ...
        if(w>=s)
        {
            for(i=0;i<=cntw;i++)
            {
               // cout<<"I "<<i<<endl;
                ...
                ll war_axe_taken1=min(i,p/w);///
                ll rem_wt_p=max(0ll,p-(war_axe_taken1*w));
                ll war_axe_rem=cntw-war_axe_taken1;
                ll sword_taken1=min(rem_wt_p/s,cnts);///
                ll sword_rem=cnts-sword_taken1;

                //cout<<"WAR rem "<<war_axe_rem<<" sword rem "<<sword_rem<<endl;
                //rem_wt_p

               // if(i==3)
               // {
                    //cout<<"WAR1 "<<war_axe_taken1<<" SWORD1 "<<sword_taken1<<endl;

               // }


                ll sword_taken2=min(sword_rem,f/s);
                ll rem_wt_f=max(0ll,f-sword_taken2*s);

                //cout<<"rem wt f "<<rem_wt_f<<endl;

                ll war_axe_taken2=min(rem_wt_f/w,war_axe_rem);

               // if(i==3)
               // {
                   // cout<<"WAR2 "<<war_axe_taken2<<" SWORD2 "<<sword_taken2<<endl;

               // }

                ll t=war_axe_taken1+war_axe_taken2+sword_taken1+sword_taken2;
        ...
        else
        {
            for(i=0;i<=cnts;i++)
            {
               // cout<<"I "<<i<<endl;
                ...
                ll sword_taken1=min(i,p/s);///
                ll rem_wt_p=max(0ll,p-(sword_taken1*s));
                ll sword_rem=cnts-sword_taken1;
                ll war_axe_taken1=min(rem_wt_p/w,cntw);///
                ll war_axe_rem=cntw-war_axe_taken1;
               ...
               // }
                ...
                ll war_axe_taken2=min(war_axe_rem,f/w);
                ll rem_wt_f=max(0ll,f-war_axe_taken2*w);

                //cout<<"rem wt f "<<rem_wt_f<<endl;

                ll sword_taken2=min(rem_wt_f/s,sword_rem);
